...
from lib.utils.optimizer.lr_scheduler import ExponentialLR, MultiStepLR, WarmupMultiStepLR
...
def make_lr_scheduler(cfg, optimizer):
    ...
    if cfg_scheduler.type == "multi_step":
        ...
        scheduler = ExponentialLR(optimizer, decay_epochs=cfg_scheduler.decay_epochs, gamma=cfg_scheduler.gamma)
    return scheduler
